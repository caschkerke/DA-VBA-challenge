Sub testrun()
    ...
    For Each ws In Worksheets
        ...
        ws.Cells(4, 17).Value = VolMax
            ...
            With ActiveSheet.Range("J2", Range("J2").End(xlDown)).FormatConditions.Add(xlCellValue, xlLess, "=0")
                .Interior.ColorIndex = 3
            End With
            With ActiveSheet.Range("J2", Range("J2").End(xlDown)).FormatConditions.Add(xlCellValue, xlGreater, "=0")
